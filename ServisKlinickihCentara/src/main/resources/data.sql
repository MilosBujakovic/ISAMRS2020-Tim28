...
insert into servisklinickihcentara.user (dtype,id,email, password, name, surname, enabled, last_password_reset_date, address,city,country,phone_number,insurance_number, uuid) VALUES ('PATIENT',12,'zarkozarkovic@gmail.com', '$2a$10$1VZ0mgHBP2378x/62R/pn.eNlhdADdsYo3R1Gb4jvJvcWE2RoyZEK', 'Zarko', 'Zarkovic', true, '2019-07-13 11:58:58.508','Maksima Gorkog 23','Novi Sad','Srbija','9554234','in3', 'b9414b2b-32e2-4cee-9f3a-f2b5e9122fee');
